In this folder you will find the developpement of some dbt models from the course under the subfolder "learning_dbt_zoomcamp" and the dbt fundamentalt tutorial under the "jaffle_shop" folder.
